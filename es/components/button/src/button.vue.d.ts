declare const _default: import("vue").DefineComponent<{
    ...
    readonly tag: import("../../../utils").EpPropFinalized<StringConstructor, unknown, unknown, "button", boolean>;
}, {
    ...
    ElIcon: import("../../../utils").SFCWithInstall<import("vue").DefineComponent<{
        ...
        style: import("vue").ComputedRef<import("vue").CSSProperties>; /** @description button size */
